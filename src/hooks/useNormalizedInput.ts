    ...
    try {
      const response = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        headers: {
          ...
          Authorization: `Bearer ${import.meta.env.VITE_OPENAI_API_KEY}`, // Use variável de ambiente
        },
        body: JSON.stringify({
          model: "gpt-4o-mini",
          messages: [
      ...
      setLoading(false);
      return normalizedValue || input; // Se não conseguir normalizar, retorna o original
    } catch (error) {
